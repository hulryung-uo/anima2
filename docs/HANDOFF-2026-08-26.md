# Historical handoff — 2026-08-26

Archived from `CLAUDE.md` at `e0d9d24`. This is historical evidence, not the current
implementation status or work queue. See the root `CLAUDE.md` for current instructions.

# CLAUDE.md — anima2

**Read [`docs/DESIGN.md`](DESIGN.md) first.** It is the source of truth:
...
narrative is in [`docs/HISTORY.md`](HISTORY.md), per-phase detail in
[`docs/PHASE2.md`](PHASE2.md) … [`docs/PHASE7.md`](PHASE7.md). 1300+ tests,
...
- **Autonomy thread** ([`docs/AUTONOMY-ROADMAP.md`](AUTONOMY-ROADMAP.md)): the
...
newer [`docs/AUTONOMY-ROADMAP.md`](AUTONOMY-ROADMAP.md) §E states the actual
...
chosen, built, and closed: [`docs/IMPLEMENTATION.md`](IMPLEMENTATION.md).
